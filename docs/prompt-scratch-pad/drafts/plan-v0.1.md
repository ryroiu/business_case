...
**Version:** 0.1 — September 21, 2026. First planning draft.

**Basis:** [Specification v0.2](../../design/specification.md), [business case](../../design/business-case.md), and the [course plan guide](../../design/reference/plan-guide.md). Requirement IDs below refer to the specification. This is the Week 4 planning assignment for the fictional Alder Systems case.
...
| --- | --- | --- |
| AI-assisted consistency review | Pending | First draft; evaluate against the specification and course guides. |
